...
{
    public class PriorityAssemblyResolver : IResolver, IDisposable
    {
        bool disposed;
        ...
        public PriorityAssemblyResolver(string bindingPath, string assemblyStartsWith, string assemblyEndsWith)
        {
