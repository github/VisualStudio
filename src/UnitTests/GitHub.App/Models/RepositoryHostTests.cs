...
public class RepositoryHostTests
{
    public class TheLoginMethod
    {
        ...
        public async Task SetsTheLoggedInBitWhenLoginIsSuccessful()
        {
            ...
            apiClient.GetOrCreateApplicationAuthenticationCode(Arg.Any<Func<TwoFactorAuthorizationException, IObservable<TwoFactorChallengeResult>>>(), Args.String, Args.Boolean)
