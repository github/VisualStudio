...
+new";
        ...
        public class TheMatchLineMethod
        {
            ...
            [TestCase("@@ -1 +1 @@. 1.+2", "@@ -1 +1 @@. 1", 0)]
            [TestCase("@@ -1 +1 @@.+2. 1", "@@ -1 +1 @@. 1", 1)]
            ...
            public void MatchLine(string lines1, string lines2, int skip /* -1 for no match */)
            {
                ...
                Assert.That(matchLine, Is.EqualTo(expectLine));
            }
        }

        public class TheMatchLineIgnoreCommentsMethod
        {
            [TestCase("@@ -1 +1 @@. x", "@@ -1 +1 @@-x.+//x", 0)] // Ignore extra '/' char.
            [TestCase("@@ -1 +1 @@. x", "@@ -1 +1 @@-x.+ x", 0)] // Ignore extra ' ' char.
            [TestCase("@@ -1 +1 @@. x", "@@ -1 +1 @@-x.+\tx", 0)] // Ignore extra '\t' char.
            [TestCase("@@ -1 +1 @@. x", "@@ -1 +1 @@-x.+!x", -1)] // Don't ignore extra '!' char.
